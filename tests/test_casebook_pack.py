"""Regression checks for the ledger-data-warehouse-mesh casebook."""
...
from casebook.harness import assert_expected, ledger_data_warehouse_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ledger_data_warehouse_mesh_summary(), assert_expected())
