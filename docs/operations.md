...
`ledger-data-warehouse-mesh` is centered on data engineering work in C++. The technical target is: Build a C++ toolkit that studies warehouse behavior through layout fixtures, with stable geometry snapshots and no network dependency.
